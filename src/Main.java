...
public class Main {
    public static List<Produto> listaProdutos(){
        ...
        return Arrays.asList(
                ...
                new Alimento(2, "Arroz", 3, 25.0, 5.0, LocalDateTime.now(), LocalDateTime.of(2021, 8, 3, 0, 0)),
                new Alimento(9, "Soja", 4, 12.0, 2.0, LocalDateTime.of(2020, 3, 21, 0, 0), LocalDateTime.of(2021, 1, 2, 0, 0)),
                new Informatica(6, "IPhone X", 2, 3500.0, "Apple", "branco"),
                new Informatica(10, "Notebook ruim", 1, 1665.0, "Positivo", "preto"),
                new Informatica(21, "Teclado de qualidade duvidosa123", 3, 125.0, "Positivo", "preto"),
                new Informatica(34, "Teclado Mecanico Acer", 2, 799.0,"Acer", "preto"));
    }
    public static void main(String[] args) {
        List<Produto> produtos = listaProdutos(); //Lista de produtos gênericos

        // F A C T O R I E S
        Estoque estoque; // Uma variavel estoque gênerica
        System.out.println("-------------------------------------------------------------------------------");
        ...
        estoque.remover(5); // Remove
        estoque.listar();
        System.out.println("-------------------------------------------------------------------------------");
        System.out.println("-------------------------> ESTOQUE DE ALIMENTOS <-----------------------------");
        /* A variavel agora possui um objeto EstoqueAlimento */
